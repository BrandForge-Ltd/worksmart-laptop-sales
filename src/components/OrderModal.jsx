  ...
  const handleWhatsAppOrder = (e) => {
    ...
    if (typeof window !== 'undefined' && window.fbq) {
      window.fbq('track', 'Lead', {
        content_name: 'Dell 3190',
        currency: 'NGN',
        value: 120000
      });
    }

    const message = `Hello, I want to order the Dell 3190.%0A%0A*Name:* ${formData.name}%0A*Email:* ${formData.email}%0A*Phone:* ${formData.phone}%0A*State:* ${formData.state}%0A*LGA:* ${formData.lga}%0A*Address:* ${formData.address}%0A%0A*Delivery Terms:* ${deliveryTerms}`;
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <p className="text-brand-muted text-sm">
                    {step === 1 ? "Enter your contact info to get started." : "Where should we deliver your Dell 3190?"}
                  </p>
                </div>
